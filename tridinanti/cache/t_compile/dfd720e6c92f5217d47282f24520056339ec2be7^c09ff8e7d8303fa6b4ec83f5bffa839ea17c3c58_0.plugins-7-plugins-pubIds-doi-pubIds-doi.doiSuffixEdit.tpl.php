...
/* Smarty version 3.1.39, created on 2026-07-22 12:57:57
  from 'plugins-7-plugins-pubIds-doi-pubIds-doi:doiSuffixEdit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_6a605be55701e9_50007428',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c09ff8e7d8303fa6b4ec83f5bffa839ea17c3c58' => 
    array (
      0 => 'plugins-7-plugins-pubIds-doi-pubIds-doi:doiSuffixEdit.tpl',
      1 => 1664910542,
      2 => 'plugins-7-plugins-pubIds-doi-pubIds-doi',
    ),
  ),
  'includes' => 
  array (
...
function content_6a605be55701e9_50007428 (Smarty_Internal_Template $_smarty_tpl) {
...
$_block_repeat=true;
echo $_block_plugin6->smartyFBVFormArea(array('id'=>"pubIdDOIFormArea",'class'=>"border",'title'=>"plugins.pubIds.doi.editor.doi"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		...
		<?php if ($_smarty_tpl->tpl_vars['pubIdPlugin']->value->getSetting($_smarty_tpl->tpl_vars['currentContext']->value->getId(),'doiSuffix') == 'customId' || $_smarty_tpl->tpl_vars['storedPubId']->value) {?>
			<?php if (empty($_smarty_tpl->tpl_vars['storedPubId']->value)) {?> 				<?php $_block_plugin7 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0][0] : null;
...
?>
				...
				<?php }?>
			<?php } else { ?> 			<?php $_block_plugin8 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0][0] : null;
...
?>
		...
		<?php }?>
	<?php $_block_repeat=false;
echo $_block_plugin6->smartyFBVFormArea(array('id'=>"pubIdDOIFormArea",'class'=>"border",'title'=>"plugins.pubIds.doi.editor.doi"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
...
$_block_repeat=true;
echo $_block_plugin9->smartyFBVFormArea(array('id'=>"pubIdDOIFormArea",'class'=>"border",'title'=>$_smarty_tpl->tpl_vars['formAreaTitle']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin10->smartyFBVFormSection(array('list'=>"true",'description'=>"plugins.pubIds.doi.editor.clearIssueObjectsDoi.description"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
?>
			<?php $_block_repeat=false;
echo $_block_plugin10->smartyFBVFormSection(array('list'=>"true",'description'=>"plugins.pubIds.doi.editor.clearIssueObjectsDoi.description"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php $_block_repeat=false;
echo $_block_plugin9->smartyFBVFormArea(array('id'=>"pubIdDOIFormArea",'class'=>"border",'title'=>$_smarty_tpl->tpl_vars['formAreaTitle']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php }
}
