...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_6a601102a5c848_20662833',
...
function content_6a601102a5c848_20662833 (Smarty_Internal_Template $_smarty_tpl) {
...
$_block_repeat=true;
echo $_block_plugin9->smartyFBVFormSection(array('class'=>"formButtons form_buttons"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
" class="cancelButton"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>$_smarty_tpl->tpl_vars['FBV_cancelText']->value),$_smarty_tpl ) );?>
	...
	<?php }
$_block_repeat=false;
echo $_block_plugin9->smartyFBVFormSection(array('class'=>"formButtons form_buttons"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
