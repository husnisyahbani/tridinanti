...
/* Smarty version 3.1.39, created on 2026-07-22 12:57:57
  from 'plugins-7-plugins-pubIds-urn-pubIds-urn:urnSuffixEdit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_6a605be54fb4b1_67116788',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2c3391dfc4f485afa654e89b9f810e5a982123f5' => 
    array (
      0 => 'plugins-7-plugins-pubIds-urn-pubIds-urn:urnSuffixEdit.tpl',
      1 => 1664910542,
      2 => 'plugins-7-plugins-pubIds-urn-pubIds-urn',
    ),
  ),
  'includes' => 
  array (
...
function content_6a605be54fb4b1_67116788 (Smarty_Internal_Template $_smarty_tpl) {
...
$_block_repeat=true;
echo $_block_plugin2->smartyFBVFormArea(array('id'=>"pubIdURNFormArea",'class'=>"border",'title'=>"plugins.pubIds.urn.editor.urn"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
?>
		...
		<?php }?>
	<?php $_block_repeat=false;
echo $_block_plugin2->smartyFBVFormArea(array('id'=>"pubIdURNFormArea",'class'=>"border",'title'=>"plugins.pubIds.urn.editor.urn"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);
}
...
$_block_repeat=true;
echo $_block_plugin4->smartyFBVFormArea(array('id'=>"pubIdURNIssueobjectsFormArea",'class'=>"border",'title'=>$_smarty_tpl->tpl_vars['formAreaTitle']->value), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin5->smartyFBVFormSection(array('list'=>"true",'description'=>"plugins.pubIds.urn.editor.clearIssueObjectsURN.description"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
?>
			<?php $_block_repeat=false;
echo $_block_plugin5->smartyFBVFormSection(array('list'=>"true",'description'=>"plugins.pubIds.urn.editor.clearIssueObjectsURN.description"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php $_block_repeat=false;
echo $_block_plugin4->smartyFBVFormArea(array('id'=>"pubIdURNIssueobjectsFormArea",'class'=>"border",'title'=>$_smarty_tpl->tpl_vars['formAreaTitle']->value), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php }
}
